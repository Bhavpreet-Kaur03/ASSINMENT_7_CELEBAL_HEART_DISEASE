...
if submitted:
    # Create input dataframe with RAW categorical values (let the pipeline handle encoding)
    ...
    # NO MANUAL ENCODING - Let the model pipeline handle it!
    try:
        # Debug: Show what we're sending to the model
        st.write("Debug - Input data being sent to model:", input_df)
        
        # Prediction (pipeline will handle preprocessing automatically)
